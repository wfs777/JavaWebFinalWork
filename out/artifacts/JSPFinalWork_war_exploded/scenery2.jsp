...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Search-->
    <form action="scenery2.jsp" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"  method="post">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">家乡风景</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">家乡风景</li>
                </ol>

                <div>

                    <a href="scenery.jsp" class="btn btn-primary btn-icon-split" id="button1">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-flag"></i>
                                        </span>
                        <span class="text">返回风景页面</span>
                    </a>
                </div>
                ...
                <%
                    String SearchMess=new String(request.getParameter("searchMess").getBytes("iso-8859-1"), "utf-8");
                    SceneDAO sceneDAO = new SceneDAO();
                    List<Scene> list1 = sceneDAO.SearchScene(SearchMess);
                    int num = list1.size();
                    int col;
                    if(num==1){
                        col =1;
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">等级：<%=list1.get(i).getRank()%></h6>
                            </div>
                            <div class="card-body">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <%=list1.get(i).getInfo()%>

...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Search-->
    <form action="culture2.jsp" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"  method="post">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">归属：<%=list1.get(i).getClassify()%></h6>
                            </div>
                            <div class="card-body">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <%=list1.get(i).getInfo()%>

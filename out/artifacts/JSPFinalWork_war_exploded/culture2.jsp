...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Search-->
    <form action="culture2.jsp" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0"
          method="post">
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">象山文化</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">象山文化</li>
                </ol>
                <div>
                    <a href="culture.jsp" class="btn btn-primary btn-icon-split" id="button1">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-flag"></i>
                                        </span>
                        <span class="text">返回文化页面</span>
                    </a>
                </div>
                <div>&nbsp;</div>
                ...
                <%
                    ...
                    List<Custom> list1 = customDAO.SearchCustom(SearchMess);
                    int num = list1.size();
                    int col;
                    if (num == 1) {
                        col = 1;
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">归属：<%=list1.get(i).getClassify()%>
                                </h6>
                            </div>
                            <div class="card-body">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

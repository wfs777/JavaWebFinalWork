...
<jsp:useBean id="dataBean" class="com.dao.FoodDAO"
             scope="session"/>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div>
                    <a href="food.jsp" class="btn btn-primary btn-icon-split" id="button1">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-flag"></i>
                                        </span>
                        <span class="text">返回家乡页面</span>
                    </a>
                </div>
                ...
                <%
                    ...
                    List<Food> list1 = foodDAO.SearchFood(SearchMess);
